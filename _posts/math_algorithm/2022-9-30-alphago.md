...
\begin{array}{ccc}
\hline
\text{Feature}              & \text{\#of planes} & \text{Description}                                                \\ \hline
...
\text{Ladder capture}       & 1           & \text{Whether a move at this point is a successful ladder move}   \\
...
<figure style="text-align:center;">
  <img src="{{ site.BASE_PATH }}/assets/images/alphago_pilicy_network.png" width="500" alt="1"/>
</figure>
...
选择分数最高的动作$a_t$，这个过程被称之为**选择**。

在动作$a_t$被执行之后，局面被更新为$s'_t$，注意到$s'_t$指的是“对手”需要着子的状态，并非指的是我们在执行动作$a_t$之后所面临的下一个需要“我们”着子的状态$s_{t+1}$。
...
最后，我们**回溯**至开始选择动作$a_t$的时候，对$a_t$的分数进行如下更新
