...
- (2) 对于每个子集$I_1 \subseteq I_2 \subseteq E$，若有$I_2 \in \mathcal{I}$，则有$I_1 \in \mathcal{I}$。（通常我们称之为遗传性（Hereditary））
...
$$
\mathcal{I} \triangle \{I \subseteq E \mid I\text{是一组线性无关的向量}\}
$$
...
> **证明：** 我们使用反证法来证明我们想要的结论。假设$S$中存在两个独立集合$I_1$与$I_2$使得$|I_2| > |I_1|$且不满足公理三，即对于每一个$a \in I_2 \ I_1$，$I_1 \cup \{a\}$都不是独立集。
> 
...
> 
> $$
> |I_1 \cap I_2|w_1 + |I_1 \setminus I_2|w_2 + (m - |I_1|)w_4 > |I_1 \cap I_2|w_1 + |I_2 \setminus I_1|w_3 + (m - |I_2|)w_4
> $$
> 
> 即希望有
> 
